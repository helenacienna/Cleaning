...
import { getInboxDemoSnapshot, listInboxThreads } from './inbox-data';
...
function getDemoManagerData() {
  const inboxDemo = getInboxDemoSnapshot();
  return {
    ...
    reviewHistory: [],
    alertCards: [],
    operationsInbox: inboxDemo.threads.slice(0, 8),
    unreadInboxCount: inboxDemo.unreadCount,
    supervisorInboxCount: inboxDemo.supervisorThreads.length,
    cleanerInboxCount: inboxDemo.cleanerThreads.length,
    reportingCards: [],
