...
const HOLIDAY_TESTING_RESET_COOLDOWN_MS = 5 * 60 * 1000;
...
async function resetHolidayTestingResultsIfEnabled({ requested = false } = {}) {
...
export async function getCleanerStaffList(staffSlug, selectedBoardDay, options = {}) {
  await resetHolidayTestingResultsIfEnabled({ requested: Boolean(options.resetHolidayTesting) });
